...
QT += core quick quickcontrols2 gui network webenginequick httpserver networkauth
CONFIG += c++20
...
# Executables path
DEFINES += TWITCH_BOT_PATH="./TwitchBot"
...
DEFINES += GAME_ASSET_FONTS_FOLDER="./Game/assets/fonts"
...
win32 {
    DEFINES += TWITCH_BOT_PATH="./TwitchBot.exe"
